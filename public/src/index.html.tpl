            ...
            <div class="gbs-scroll">
                <section name="presets">
                    <fieldset class="gbs-fieldset presets">
                        <legend
                            class="gbs-fieldset__legend gbs-fieldset__legend--help">
                    ...
                    <fieldset class="gbs-fieldset filters">
                        ...
                        <div class="gbs-margin__bottom--16">
                            ...
                            <ul class="gbs-help">
                                ...
                                <li>
                                    Line Filter eliminates blocky-pixel
                                    artifacts when upscaling beyond 480p, and is
                                    recommended.
                                </li>
                            </ul>
                            <div class="gbs-flex">
                            ...
                            <ul class="gbs-help">
                                ...
                                <li>
                                    Step Response increases the sharpness of
                                    horizontal color steps, and is recommended.
                                </li>
                            </ul>
                        </div>
                    </fieldset>
                        ...
                        <table class="gbs-preferences">
                            <tr>
                                <td>
                                    ...
                                    <ul class="gbs-help">
                                        <li>
                                            Low Resolution VGA input:
                                            Pass-through or Upscale
                                        </li>
                                        <li>
                                            Low resolution sources can be either
                                            passed on directly or get upscaled.
                                        </li>
                                        <li>
                                            Upscaling may have some border /
                                            scaling issues, but is more
                                            compatible with displays.
                                        </li>
                                        <li>
                                            Also, refresh rates other than 60Hz
                                            are not well supported yet.
                                        </li>
                                        <li>
                                            "Low resolution" is currently set at
                                            below or equal to 640x480 (525
                                            active lines).
                                        </li>
                                    </ul>
                                </td>
            ...
            <!-- <li>Backup is valid between devices with the same hardware revision</li> -->
                ...
                <section name="alert" hidden>
                    <fieldset class="gbs-fieldset">
                        ...
                        <div
                            class="gbs-padding__hor-16 gbs-modal__message"
                            gbs-alert-content></div>
                        <div class="gbs-flex">
                            <button
                                gbs-alert-act
                                class="gbs-button gbs-button__control"
                            ...
                            <button
                                gbs-alert-ack
                                class="gbs-button gbs-button__control gbs-button__secondary"></button>
                        </div>
                    </fieldset>
                </section>
                <div class="gbs-output">
                    <fieldset class="gbs-fieldset gbs-fieldset-output">
                        ...
                        <div
                            class="gbs-flex gbs-margin__bottom--16"
                            gbs-output-clear>
                        ...
                        <div class="gbs-flex">
                            <textarea
                                id="outputTextArea"
                                class="gbs-output__textarea"></textarea>
                        </div>
                    </fieldset>
                </div>
            </div>
